        ...
        unsigned long lineno, char **argv)
{
     ...
     * of elements in in_tab) is in the parameter int out_cnt. Use the
     * parameter char delim as the delimiter in your output records that you write to the standard output stream.
     *
     * special case!
